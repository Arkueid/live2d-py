...
LAppModel::LAppModel()
	: L2DBaseModel(), modelSetting(NULL), currentFinishCallback(NULL), _offx(0.0f), _offy(0.0f), _scale(1.0f), _ww(800), _wh(600), _eyeBlink(true)
{

	mainMotionMgr->setMotionDebugMode(LAppDefine::DEBUG_LOG);
}
...
void LAppModel::setEyeBlinkEnable(bool enable) 
{
	_eyeBlink = enable;
}

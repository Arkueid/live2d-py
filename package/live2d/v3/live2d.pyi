...
class Model:
    ...
    def StartMotion(self, group: str, no: int, priority: int = 3, 
                    startCallback: Callable[[str, int], None] = None, 
                    endCallback: Callable[[str, int], None] = None): ...
    ...
    def GetMotions(self) -> dict[str, int, str]: ...
    ...
    def SetDefaultExpression(self, expressionId: str): ...

    def SetFadeOutExpression(self, expressionId: str, fadeOutSeconds: float): ...
